					...
					<div class="col-lg-11">
						<div class="card">
							<c:choose>
								<c:when test="${param.mess eq 'exist' }">
									<div
										...
										<span class="badge badge-pill badge-danger">error</span> Hoc
										kỳ tồn tại
							...
							<div class="card-body card-block">
								<form action="/QuanLyDiem/giaovien/addhocky" method="post"
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9">
											<input type="text" id="text-input" name="tenhocky"
												placeholder="Tên Học Kỳ" class="form-control" required>
										</div>
									</div>
