					...
					<div class="col-lg-11">
						<div class="card">
							...
							<div class="card-body card-block">
								<form
									action="/QuanLyDiem/giaovien/updatemon?id_mon=${mon.id_mon }"
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9">
											<input type="text" id="text-input" name="mamon"
												placeholder="Mã" class="form-control" value="${mon.mamon }"
												required> <small class="form-text text-muted">This
												is a help text</small>
										</div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3">
											<label for="select" class=" form-control-label">Tên
												Học Phần</label>
										</div>
										<div class="col-12 col-md-9">
											<input type="text" id="text-input" name="tenmon"
												placeholder="Tên học phần" class="form-control"
												value="${mon.tenmon }" required> <small
