						...
						<div class="col-lg-12">
							...
							<div class="user-data m-b-30">
								<h3 class="title-3 m-b-30">
									<i class="zmdi zmdi-account-calendar"></i>Danh sách giáo viên
								</h3>
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<c:if test="${loginGiaoVien.role eq 0 }">
												<a href="/QuanLyDiem/giaovien/addGV"><i
									...
									<div class="table-data__tool-right">
										...
										<form class="form-header" action="/QuanLyDiem/giaovien/searchGV"
											method="POST">
												...
												<tr>
													...
													<td>
														<div class="avatar-wrap">
															<div class="avatar">
																<img
																	src="${pageContext.request.contextPath }/upload/giaovien/${gv.img }"
																	alt="${gv.hoten}">
															</div>
														</div>
													</td>
													<td>
														<div class="table-data__info">
															<a
																href="/QuanLyDiem/giaovien/detailGV?id_giaovien=${gv.id_giaovien }"><h6>${gv.hoten}</h6></a>
														</div>
													</td>
													<td>
														<div class="table-data__info">
													...
													<c:if test="${gv.role eq 0 }">
														<td><span class="role admin">Quản Trị</span></td>
													</c:if>
													<c:if test="${gv.role eq 1 }">
														<td><span class="role admin">Giáo Viên</span></td>
													</c:if>
													<c:if test="${loginGiaoVien.role eq 0 }">
														<td>
															<div class="table-data-feature">
																<button class="item" data-toggle="tooltip"
																	...
																	<a
																		href="/QuanLyDiem/giaovien/updateGV?id_giaovien=${gv.id_giaovien }">
																...
																<button class="item" data-toggle="tooltip"
																	...
																	<a
																		href="/QuanLyDiem/giaovien/delete?id_giaovien=${gv.id_giaovien }"
