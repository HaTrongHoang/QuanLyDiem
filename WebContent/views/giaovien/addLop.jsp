					...
					<div class="col-lg-11">
						<div class="card">
							<c:choose>
								<c:when test="${param.mess eq 'exist' }">
									<div
										...
										<span class="badge badge-pill badge-danger">error</span> Lop ton tai
							...
							<div class="card-body card-block">
								<form action="/QuanLyDiem/giaovien/addlop" method="post"
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9">
											<input type="text" id="text-input" name="tenlop"
												placeholder="Tên Lớp" class="form-control" required>
